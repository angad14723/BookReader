...
struct PeelEffect<Content: View>: View {
    ...
    var content: Content
    var nextPage: BookPage
    
    /// Swipe Callback  for HeadView, When Delete is Clicked
    var onSwipe: () -> ()
    
    init(@ViewBuilder content: @escaping() -> Content, onSwipe: @escaping () -> (), nextPage: BookPage) {
